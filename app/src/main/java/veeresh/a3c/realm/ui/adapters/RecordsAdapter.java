...
public class RecordsAdapter extends RealmRecyclerViewAdapter<Record, RecordsAdapter.ViewHolder> {
    ...
    public RecordsAdapter(OrderedRealmCollection<Record> orderedRealmCollection) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Glide.with(holder.itemView.getContext()).load(getData().get(position).getImage()).diskCacheStrategy(DiskCacheStrategy.SOURCE).into(holder.profilePicture);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void navigate() {
           // EventBus.getDefault().post(new VehicalEvents.RecordEvent(getData().get(getAdapterPosition()), profilePicture));
        }
